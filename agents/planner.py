    ...
    _TEMPLATES: Dict[str, List[Dict[str, Any]]] = {
        ...
        QueryIntent.RECOMMENDATION: [
            ...
            },
            {
                ...
                "param_paths":     {},
                "literal_params":  {"products": "ranked_products"},
        ...
        QueryIntent.BUDGET: [
            ...
            },
            {
                ...
                "save_as":         "ranked_products",
                "param_paths":     {"max_price": "entities.max_price", "products": "budget_products"},
            ...
            },
            {
                ...
                "save_as":         "final_response",
                "param_paths":     {},
                "literal_params":  {"include_budget_alternatives": True, "products": "ranked_products"},
                "depends_on_refs": ["ranked_products"],
            },
        ],
        ...
        QueryIntent.GOAL_BASED: [
            ...
            },
            {
                ...
                "save_as":         "final_response",
                "param_paths":     {},
                "literal_params":  {"include_health_analysis": True, "products": "ranked_products"},
                "depends_on_refs": ["ranked_products"],
            },
        ],
    }
